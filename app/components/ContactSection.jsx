    ...
    <section className="flex flex-col md:flex-row my-12 py-24 items-center md:items-start md:justify-start md:px-12 max-w-5xl mx-auto">
      <div className="md:w-2/3 mb-6 md:mb-0 md:mr-12">
        ...
        <p className="text-[#ADB7BE] mb-4 max-w-md">
          I'm always on the lookout for new opportunities and collaborations. Feel free to reach out to me via email at aadipa25@gmail.com or connect with me on LinkedIn. I look forward to connecting with you!
        </p>
      </div>
